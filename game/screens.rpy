...
screen skip_indicator():
    ...
    frame:
        ...
        hbox:
            ...
            text _("CREATING THE NEXT")

            text "▸" at delayed_blink(0.0, 0.6) style "skip_triangle"
            text "▸" at delayed_blink(0.2, 0.6) style "skip_triangle"
            text "▸" at delayed_blink(0.4, 0.6) style "skip_triangle"
